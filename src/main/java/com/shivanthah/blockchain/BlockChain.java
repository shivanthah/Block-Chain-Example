package com.shivanthah.blockchain;
...
public class BlockChain {
  ...
  public static void main(String[] args) {
    ...
    Security.addProvider(
        new org.bouncycastle.jce.provider
            .BouncyCastleProvider()); // Setup Bouncy castle as a Security Provider
    ...
    UTXOs.put(
        ...
        genesisTransaction.outputs.get(
            0)); // it's important to store our first transaction in the UTXOs list.
  ...
  public static Boolean isChainValid() {
    ...
    HashMap<String, TransactionOutput> tempUTXOs =
        new HashMap<>(); // a temporary working list of unspent transactions at a given
                                  // block state.
